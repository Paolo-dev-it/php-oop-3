...
$prodotti = [
    ...
    new Cd('Singin In The Rain', 'Gene Kelly', 13.70, $generi['drama'], true, 'https://immagine-copertina.com', 80, 'spotify', 'https://spotify-libri.com'),
    new Dvd('007', 'James Bond', 39.90, $generi['azione'], true, 'https://immagine-copertina.com', 100, 'spotify', 'https://spotify-libri.com'),
];
